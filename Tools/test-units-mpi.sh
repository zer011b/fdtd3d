...
#   ./test-units-mpi.sh <home_dir> <build_dir> "" "" "" "" "" ""
#
# To test scpecific unit test in all configurations
#   ./test-units-mpi.sh <home_dir> <build_dir> "<test_sh_path>" "" "" "" "" ""
...
for VALUE_TYPE in $VALUE_TYPE_VALUES; do
  ...
  ${SCRIPT} ${HOME_DIR} ${BUILD_DIR} ${CMAKE_CXX_COMPILER} ${CMAKE_C_COMPILER} ${CMAKE_BUILD_TYPE} ${CXX11_ENABLED} ${COMPLEX_FIELD_VALUES} ${VALUE_TYPE}
