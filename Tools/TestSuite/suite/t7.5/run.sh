...
function launch ()
{
  ...
  ./fdtd3d $CUDA_MODE --time-steps $num_time_steps --sizey $sizez --1d-ezhx --angle-teta 90 --angle-phi 90 --angle-psi 90 \
    ...
    --norm-start-y $norm_start --norm-end-y $norm_end --calc-${exp_type}-ezhx-diff-norm &> $output_file
