...
function launch ()
{
  ...
  tmp_test_file=$(mktemp /tmp/vacuum2D_TMy.XXXXXXXX.txt)
  cp ${SOURCE_DIR}/Examples/vacuum2D_TMy.txt $tmp_test_file
  ...
  ./fdtd3d --cmd-from-file ${SOURCE_DIR}/Examples/vacuum2D_TMy_scattered.txt &> $output_file
