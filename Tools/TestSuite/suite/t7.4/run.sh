...
function launch ()
{
  ...
  $RUNNER ./fdtd3d $MODE --time-steps $num_time_steps --sizex $sizez --1d-eyhz --angle-teta 90 --angle-phi 0 --angle-psi 0 \
    ...
    --norm-start-x $norm_start --norm-end-x $norm_end --calc-${exp_type}-eyhz-diff-norm &> $output_file
