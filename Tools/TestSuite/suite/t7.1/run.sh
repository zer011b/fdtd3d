...
function launch ()
{
  ...
  $RUNNER ./fdtd3d $MODE --time-steps $num_time_steps --sizez $sizez --1d-exhy --angle-teta 0 --angle-phi 0 --angle-psi 90 \
    ...
    --norm-start-z $norm_start --norm-end-z $norm_end --calc-${exp_type}-exhy-diff-norm --layout-type $layout_type &> $output_file
