...
function launch ()
{
  ...
  ./fdtd3d --time-steps $num_time_steps --sizex $sizez --1d-ezhy --angle-teta 90 --angle-phi 0 --angle-psi 90 \
    ...
    --norm-start-x $norm_start --norm-end-x $norm_end --calc-${exp_type}-ezhy-diff-norm &> $output_file
