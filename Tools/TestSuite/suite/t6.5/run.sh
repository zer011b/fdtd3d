...
function launch ()
{
  ...
  tmp_test_file=$(mktemp /tmp/vacuum2D_TMx.XXXXXXXX.txt)
  cp ${SOURCE_DIR}/Examples/vacuum2D_TMx.txt $tmp_test_file
  ...
  ./fdtd3d --cmd-from-file ${SOURCE_DIR}/Examples/vacuum2D_TMx_scattered.txt &> $output_file
