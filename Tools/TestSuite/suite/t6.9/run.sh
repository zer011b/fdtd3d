...
function launch ()
{
  ...
  ./fdtd3d --cmd-from-file ${SOURCE_DIR}/Examples/vacuum1D_ExHz.txt &> $output_file
  ...
  ./fdtd3d --cmd-from-file ${SOURCE_DIR}/Examples/vacuum1D_ExHz_scattered.txt &> $output_file
