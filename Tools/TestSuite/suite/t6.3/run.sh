...
function launch ()
{
  ...
  tmp_test_file=$(mktemp /tmp/vacuum2D_TEy.XXXXXXXX.txt)
  cp ${SOURCE_DIR}/Examples/vacuum2D_TEy.txt $tmp_test_file
  ...
  ./fdtd3d --cmd-from-file ${SOURCE_DIR}/Examples/vacuum2D_TEy_scattered.txt &> $output_file
