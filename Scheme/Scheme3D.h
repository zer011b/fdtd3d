...
public:
  ...
  Scheme3D (const GridCoordinate3D& totSize,
    ...
    Eps (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    Mu (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    OmegaPE (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    GammaE (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    OmegaPM (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    GammaM (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    SigmaX (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    SigmaY (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    SigmaZ (yeeLayout.getEpsSize (), bufSizeL + GridCoordinate3D (1, 1, 1), bufSizeR + GridCoordinate3D (1, 1, 1), curProcess, totalProc, 0),
    sourceWaveLength (0),
    sourceFrequency (0),
    courantNum (0),
    gridStep (0),
