...
function launch ()
{
  ...
  $RUNNER "$RUNPATH"fdtd3d $MODE --time-steps $num_time_steps --size z:$sizez --1d-eyhx --angle-teta 0 --angle-phi 90 --angle-psi 90 \
    ...
    --norm-start z:$norm_start --norm-end z:$norm_end --calc-${exp_type}-eyhx-diff-norm --layout-type $layout_type &> $output_file
