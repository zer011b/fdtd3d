...
template<>
void
BMPDumper<Grid1D>::dumpGrid (Grid1D& grid) const
{
#if PRINT_MESSAGE
...
template<>
void
BMPDumper<Grid2D>::dumpGrid (Grid2D& grid) const
{
#if PRINT_MESSAGE
...
template<>
void
BMPDumper<Grid3D>::dumpGrid (Grid3D& grid) const
{
...
template<>
void
BMPDumper<Grid1D>::writeToFile (Grid1D& grid, GridFileType dump_type)
{
  const GridCoordinate1D& size = grid.getSize ();
  grid_coord sx = size.getX ();
  grid_coord sy = 1;
...
template<>
void
BMPDumper<Grid2D>::writeToFile (Grid2D& grid, GridFileType dump_type)
{
  const GridCoordinate2D& size = grid.getSize ();
  grid_coord sx = size.getX ();
  grid_coord sy = size.getY ();;
...
template<>
void
BMPDumper<Grid3D>::writeToFile (Grid3D& grid, GridFileType dump_type)
{
  ASSERT_MESSAGE ("3D Dumper is not implemented.")
}
...
template<>
void
BMPDumper<Grid1D>::writeToFile (Grid1D& grid)
{
...
template<>
void
BMPDumper<Grid2D>::writeToFile (Grid2D& grid)
{
  writeToFile (grid, CURRENT);
#if defined (ONE_TIME_STEP) || defined (TWO_TIME_STEPS)
  if (type == ALL)
...
template<>
void
BMPDumper<Grid3D>::writeToFile (Grid3D& grid)
{
  ASSERT_MESSAGE ("3D Dumper is not implemented.")
}
