                                       ...
                                       time_step t)
{
  ...
  Ex[indexEx1] = calculateEx_3D (Ex_prev[indexEx1],
                                 Hz_prev[indexEx1],
                                 Hz_prev[indexEx2],
                                 Hy_prev[indexEx1],
                                 Hy_prev[indexEx3],
                                       ...
                                       time_step t)
{
  ...
  Ey[indexEy1] = calculateEy_3D (Ey_prev[indexEy1],
                                 Hx_prev[indexEy1],
                                 Hx_prev[indexEy3],
                                 Hz_prev[indexEy1],
                                 Hz_prev[indexEy3],
                                       ...
                                       time_step t)
{
  ...
  Hx[indexHx1] = calculateHx_3D (Hx_prev[indexHx1],
                                 Ey_prev[indexHx3],
                                 Ey_prev[indexHx1],
                                 Ez_prev[indexHx2],
                                 Ez_prev[indexHx1],
                                       ...
                                       time_step t)
{
  ...
  Hy[indexHy1] = calculateHy_3D (Hy_prev[indexHy1],
                                 Ez_prev[indexHy2],
                                 Ez_prev[indexHy1],
                                 Ex_prev[indexHy3],
                                 Ex_prev[indexHy1],
