...
{
  ASSERT (posDown.getX () == posUp.getX () && posDown.getY () < posUp.getY () && posDown.getZ () == posUp.getZ ());
  ASSERT (posBack.getX () == posFront.getX () && posBack.getY () == posFront.getY () && posBack.getZ () < posFront.getZ ());
...
{
  ASSERT (posLeft.getX () < posRight.getX () && posLeft.getY () == posLeft.getY () && posLeft.getZ () == posRight.getZ ());
  ASSERT (posBack.getX () == posFront.getX () && posBack.getY () == posFront.getY () && posBack.getZ () < posFront.getZ ());
