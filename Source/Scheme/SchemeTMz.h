...
public:
  ...
  SchemeTMz (ParallelYeeGridLayout *layout,
    ...
    yeeLayout (layout),
    Ez (layout->getEzSize ().shrink (), bufSize, 0, layout->getEzSizeForCurNode (), layout->getEzCoreSizePerNode ()),
    Hx (layout->getHxSize ().shrink (), bufSize, 0, layout->getHxSizeForCurNode (), layout->getHxCoreSizePerNode ()),
    Hy (layout->getHySize ().shrink (), bufSize, 0, layout->getHySizeForCurNode (), layout->getHyCoreSizePerNode ()),
    Dz (layout->getEzSize ().shrink (), bufSize, 0, layout->getEzSizeForCurNode (), layout->getEzCoreSizePerNode ()),
    Bx (layout->getHxSize ().shrink (), bufSize, 0, layout->getHxSizeForCurNode (), layout->getHxCoreSizePerNode ()),
    By (layout->getHySize ().shrink (), bufSize, 0, layout->getHySizeForCurNode (), layout->getHyCoreSizePerNode ()),
    D1z (layout->getEzSize ().shrink (), bufSize, 0, layout->getEzSizeForCurNode (), layout->getEzCoreSizePerNode ()),
    B1x (layout->getHxSize ().shrink (), bufSize, 0, layout->getHxSizeForCurNode (), layout->getHxCoreSizePerNode ()),
    B1y (layout->getHySize ().shrink (), bufSize, 0, layout->getHySizeForCurNode (), layout->getHyCoreSizePerNode ()),
    EzAmplitude (layout->getEzSize ().shrink (), bufSize, 0, layout->getEzSizeForCurNode (), layout->getEzCoreSizePerNode ()),
    HxAmplitude (layout->getHxSize ().shrink (), bufSize, 0, layout->getHxSizeForCurNode (), layout->getHxCoreSizePerNode ()),
    HyAmplitude (layout->getHySize ().shrink (), bufSize, 0, layout->getHySizeForCurNode (), layout->getHyCoreSizePerNode ()),
    Eps (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    Mu (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getMuSizeForCurNode (), layout->getMuCoreSizePerNode ()),
    OmegaPE (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    GammaE (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    OmegaPM (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    GammaM (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    SigmaX (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    SigmaY (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    SigmaZ (layout->getEpsSize ().shrink (), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode (), layout->getEpsCoreSizePerNode ()),
    sourceWaveLength (0),
    sourceFrequency (0),
    courantNum (0),
    gridStep (0),
