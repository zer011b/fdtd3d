...
public:
  ...
  SchemeTMz (ParallelYeeGridLayout *layout,
    ...
    Mu (layout->getEpsSize ().shrink (), bufSize, 0, layout->getMuSizeForCurNode ()),
    OmegaPE (layout->getEpsSize ().shrink (), bufSize, 0, layout->getEpsSizeForCurNode ()),
    GammaE (layout->getEpsSize ().shrink (), bufSize, 0, layout->getEpsSizeForCurNode ()),
    OmegaPM (layout->getEpsSize ().shrink (), bufSize, 0, layout->getEpsSizeForCurNode ()),
    GammaM (layout->getEpsSize ().shrink (), bufSize, 0, layout->getEpsSizeForCurNode ()),
