...
public:
  ...
  SchemeTMz (ParallelYeeGridLayout *layout,
    ...
    yeeLayout (layout),
    Ez (shrinkCoord (layout->getEzSize ()), bufSize, 0, layout->getEzSizeForCurNode ()),
    Hx (shrinkCoord (layout->getHxSize ()), bufSize, 0, layout->getHxSizeForCurNode ()),
    Hy (shrinkCoord (layout->getHySize ()), bufSize, 0, layout->getHySizeForCurNode ()),
    Dz (shrinkCoord (layout->getEzSize ()), bufSize, 0, layout->getEzSizeForCurNode ()),
    Bx (shrinkCoord (layout->getHxSize ()), bufSize, 0, layout->getHxSizeForCurNode ()),
    By (shrinkCoord (layout->getHySize ()), bufSize, 0, layout->getHySizeForCurNode ()),
    D1z (shrinkCoord (layout->getEzSize ()), bufSize, 0, layout->getEzSizeForCurNode ()),
    B1x (shrinkCoord (layout->getHxSize ()), bufSize, 0, layout->getHxSizeForCurNode ()),
    B1y (shrinkCoord (layout->getHySize ()), bufSize, 0, layout->getHySizeForCurNode ()),
    EzAmplitude (shrinkCoord (layout->getEzSize ()), bufSize, 0, layout->getEzSizeForCurNode ()),
    HxAmplitude (shrinkCoord (layout->getHxSize ()), bufSize, 0, layout->getHxSizeForCurNode ()),
    HyAmplitude (shrinkCoord (layout->getHySize ()), bufSize, 0, layout->getHySizeForCurNode ()),
    Eps (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    Mu (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getMuSizeForCurNode ()),
    OmegaPE (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    GammaE (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    OmegaPM (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    GammaM (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    SigmaX (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    SigmaY (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    SigmaZ (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    sourceWaveLength (0),
    sourceFrequency (0),
    courantNum (0),
    gridStep (0),
