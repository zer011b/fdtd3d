...
public:
  ...
  SchemeTEz (ParallelYeeGridLayout *layout,
    ...
    yeeLayout (layout),
    Ex (shrinkCoord (layout->getExSize ()), bufSize, 0, layout->getExSizeForCurNode ()),
    Ey (shrinkCoord (layout->getEySize ()), bufSize, 0, layout->getEySizeForCurNode ()),
    Hz (shrinkCoord (layout->getHzSize ()), bufSize, 0, layout->getHzSizeForCurNode ()),
    Dx (shrinkCoord (layout->getExSize ()), bufSize, 0, layout->getExSizeForCurNode ()),
    Dy (shrinkCoord (layout->getEySize ()), bufSize, 0, layout->getEySizeForCurNode ()),
    Bz (shrinkCoord (layout->getHzSize ()), bufSize, 0, layout->getHzSizeForCurNode ()),
    ExAmplitude (shrinkCoord (layout->getExSize ()), bufSize, 0, layout->getExSizeForCurNode ()),
    EyAmplitude (shrinkCoord (layout->getEySize ()), bufSize, 0, layout->getEySizeForCurNode ()),
    HzAmplitude (shrinkCoord (layout->getHzSize ()), bufSize, 0, layout->getHzSizeForCurNode ()),
    Eps (shrinkCoord (layout->getEpsSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getEpsSizeForCurNode ()),
    Mu (shrinkCoord (layout->getMuSize ()), bufSize + GridCoordinate2D (1, 1), 0, layout->getMuSizeForCurNode ()),
